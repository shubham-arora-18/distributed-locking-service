...
def test_decode_jwt_exception():
    expired_token = (
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkI"
        "joia3Jpc2huYSIsImV4cCI6MTY3Mzg1ODEzNX0"
        ".gBrsAN5EHdnikCY-tEEtauqE02WFRq8oby5Iqm1JDC0"
    )
...
def test_decode_jwt_invalid_jwt_2():
    expired_token = (
        "eyJ0eXAiOiIiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoia3"
        "Jpc2huYSIsImV4cCI6NDEwMjM1ODQwMH0"
