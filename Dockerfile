...
#command to build this docker image:docker buildx build -t asia-south1-docker.pkg.dev/distributed-locking-service/docker-repo/docker-image:version4 --build-arg base_image=base_image:1 --platform linux/amd64 .
